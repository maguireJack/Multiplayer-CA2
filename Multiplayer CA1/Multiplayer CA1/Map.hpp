...
{
public:
	Map(World* world, std::string path, std::string textureAtlas, int tilesX, std::map<int, sf::Vector2f>& tank_spawns, std::vector<sf::Vector2f>& pickup_spawners, sf::Vector2f world_center, float spawn_offset, bool load_map);	
